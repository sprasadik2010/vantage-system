            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  disabled={!isEditing}
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm disabled:bg-gray-50"
                  placeholder="Enter your cryptocurrency wallet address or bank details for withdrawals"
                />
                <p className="mt-1 text-xs text-gray-500">
            ...
            <div className="bg-purple-50 rounded-lg p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-purple-700">${user?.total_withdrawn?.toFixed(2)}</p>
                </div>
              </div>
            </div>
          </div>
